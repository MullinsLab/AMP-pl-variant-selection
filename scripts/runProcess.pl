...
$ntfile =~ s/_REN_pblib.fasta/_env_pblib_NT.fasta/;
...
$aafile =~ s/_REN_pblib.fasta/_env_pblib_AA.fasta/;
...
$ntfile =~ s/_GP_pblib.fasta/_gag_pblib_NT.fasta/;
...
$aafile =~ s/_GP_pblib.fasta/_gag_pblib_AA.fasta/;
...
$RENTfiles =~ s/_env_pblib_NT\.fasta/_RE_NT_V\*/;
